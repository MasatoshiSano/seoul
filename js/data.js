...
window.DATA = {
  ...
  expenses: [
    ...
    { date: "2026-08-27", time: "23:20", place: "영천영화 청담店（狎鴎亭ロデオ・夜の2軒目）", desc: "韓牛ユッケ・ユッケビビンバなど", krw: 42000 },
    { date: "2026-08-27", time: "23:48", place: "薬局（明洞）", desc: "ニューベインエックス（トロクセルチン、脚のむくみ改善薬）×2", krw: 6000 },
    ...
    { date: "2026-08-28", time: "10:32", place: "オリーブヤング 明洞本店", desc: "ペリペラ スピーディウォーターティント×3／LAKAサンシールドクリーム／COSRXナイアシンアミド美容液／エストラ アシカ365スージングマスク×5／ディライトプロジェクトフェイスマスク各種（1+1）", krw: 72700 },
    { date: "2026-08-28", time: "10:49", place: "HEYTEA 明洞店", desc: "ジャスミンホワイトピーチ", krw: 8500 },
    { date: "2026-08-28", time: "11:26", place: "NYU NYU 明洞4街店", desc: "キリン柄グッズ／オレンジ柄ブロックグッズ／キャラクターアクセサリー、計3点", krw: 28000 },
    { date: "2026-08-28", time: "11:45", place: "明洞中央路のビューティー薬局", desc: "Jauブランドのスキンケア2点（ハイドレイティングクリーム＋美容液、免税後）", krw: 60000 },
    ...
    { date: "2026-08-28", time: "18:06", place: "명동레디薬局（明洞8街）", desc: "파마티크 폼젤리（洗顔ジェル、割引後）", krw: 33000 },
    ...
    { date: "2026-08-29", time: "22:26", place: "ロッテマート ソウル駅店", desc: "エッグロール蟹風味／米菓／해태クランチスリム／カヌアメリカーノミニ／辛ラーメンGOLD／マーケットОリアルブラウニー／ケロッグ玄米五穀グラノーラ／ハリムユニジャジャン／トウモロコシひげ茶／海鮮トッポギ汁／CJ햇반（1+1）／オリオンスウィングチップ（1+1）／じゃがいもスティック／チヂミ風ポテトチップス／カンタータアイス缶2種（1+1）／CJ辛味ソース×2 など18点（免税後）", krw: 76180 },
    { date: "2026-08-30", time: "00:31", place: "백제정（中区多山路）", desc: "深夜の食事（カップル席）", krw: 40000 },
    { date: "2026-08-30", time: "00:59", place: "NEWNEW（東大門）", desc: "ワンピース 1着", krw: 46000 },
    { date: "2026-08-30", time: "10:19", place: "CU 金浦空港店", desc: "T-money残高払い戻し（手数料500W差引）", krw: -9210 }
  ],
  budget: [
