...
window.DATA = {
  ...
  places: [
    { category: "グルメ", tag: "食べる", spots: [
      { name: "広蔵市場", area: "鍾路", desc: "屋台グルメの宝庫。ユッケ・ピンデトク", map: "https://maps.google.com/?q=Gwangjang+Market" },
      { name: "明洞餃子", area: "明洞", desc: "カルグクス＆マンドゥの老舗", map: "https://maps.google.com/?q=Myeongdong+Kyoja" },
    ...
    { category: "グルメ候補：麺（カルグクス・マッククス・ビビン麺）", tag: "麺", spots: [
    ...
    { category: "グルメ候補：サムギョプサル・豚肉", tag: "豚肉", spots: [
    ...
    { category: "グルメ候補：カンジャンケジャン", tag: "ケジャン", spots: [
    ...
    { category: "グルメ候補：ユッケ・육회비빔밥", tag: "ユッケ", spots: [
    ...
    { category: "グルメ候補：ポッサム", tag: "ポッサム", spots: [
    ...
    { category: "グルメ候補：鍋・煮込み", tag: "鍋", spots: [
    ...
    { category: "グルメ候補：タコ・ホルモン系", tag: "ホルモン", spots: [
    ...
    { category: "グルメ候補：ベーカリー", tag: "パン", spots: [
