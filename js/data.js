...
window.DATA = {
  ...
  schedule: [
    ...
    { date: "2026-08-28", day: "28", weekday: "金", label: "2日目 ・ 鍾路＆明洞グルメ", items: [
      { time: "07:15", icon: "restaurant", title: "朝食：喜粥喜粥（히죽히죽）の鮑がゆ", place: "喜粥喜粥（忠武路）", map: "https://maps.app.goo.gl/HN1puTrr6XJkkqhe7?g_st=ic", memo: "【移動】ミリオレから徒歩約10分（忠武路方面）。【理由】粥カテゴリ必須＆1位。07:00開店で朝食に唯一使える時間帯、かつ徒歩圏。予約不要" },
      { time: "09:00", icon: "luggage", title: "ミリオレ チェックアウト → ナインツリーへ荷物移動", place: "東大門（ミリオレ → ナインツリー）", map: "https://maps.google.com/?q=Nine+Tree+by+Parnas+Seoul+Dongdaemun", memo: "【移動】喜粥喜粥から徒歩約10分でミリオレへ戻り、荷物をまとめてナインツリーへ（徒歩約10分）。11時までにミリオレをチェックアウト。正式チェックインは夜〜。それまでは自由時間" },
      { time: "12:30", icon: "restaurant", title: "昼食：ソンジョン ポッサム 鍾路店（손정보쌈）", place: "ソンジョン ポッサム 鍾路店（鍾路）", map: "https://maps.app.goo.gl/v27FHS1rSDW5wDqf7?g_st=ic", memo: "【移動】ナインツリーから地下鉄・徒歩で約15〜20分（鍾路方面）。【理由】ポッサムカテゴリ必須＆1位。11:00〜22:00(休憩14:30〜16:30・LO21:20)・CatchTable予約可" },
