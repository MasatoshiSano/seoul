...
window.DATA = {
  ...
  packing: [
    ...
    { category: "衣類・身の回り", items: ["着替え（3泊分）", "羽織り（冷房対策）", "歩きやすい靴", "折りたたみ傘", "常備薬・絆創膏", "洗面・スキンケア用品"] },
  ...
  hotel: { name: "ハイ メイト トンデムン", checkin: "2026-08-27", checkout: "2026-08-30", address: "ソウル市 東大門エリア（全室 専用バスルーム付き）", map: "https://maps.google.com/?q=Hi+Mate+Dongdaemun+Seoul" },
  budget: [
    { item: "航空券（Peach 往復）", krw: 0, jpy: 35000, memo: "MM743/MM736・1人あたり目安" },
    { item: "宿泊（3泊）", krw: 240000, jpy: 26000, memo: "東大門ホステル・1泊8万ウォン想定" },
