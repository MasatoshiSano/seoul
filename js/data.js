...
window.DATA = {
  ...
  schedule: [
    ...
    { date: "2026-08-28", day: "28", weekday: "金", label: "2日目 ・ 鍾路＆明洞グルメ", items: [
      { time: "07:00", icon: "restaurant", title: "朝食：喜粥喜粥（히죽히죽）の鮑がゆ", place: "喜粥喜粥（忠武路）", map: "https://maps.app.goo.gl/HN1puTrr6XJkkqhe7?g_st=ic", memo: "【移動】ミリオレから徒歩約15〜20分、または地下鉄4号線で1駅（動大門歴史文化公園→忠武路）＋徒歩。【理由】粥カテゴリ必須＆1位。07:00開店で朝食に唯一使える時間帯。予約不要" },
      { time: "09:00", icon: "luggage", title: "ミリオレ チェックアウト → ナインツリーへ荷物移動", place: "東大門（ミリオレ → ナインツリー）", map: "https://maps.google.com/?q=Nine+Tree+by+Parnas+Seoul+Dongdaemun", memo: "【移動】喜粥喜粥から徒歩約15〜20分、または地下鉄1駅でミリオレへ戻り、荷物をまとめてナインツリーへ（徒歩約10分）。11時までにミリオレをチェックアウト。正式チェックインは夜〜" },
      { time: "10:30", icon: "cafe", title: "コーヒー休憩：ARTIST BAKERY の塩パン", place: "ARTIST BAKERY（安国）", map: "https://maps.google.com/?q=Artist+Bakery+Anguk", memo: "【移動】ナインツリーから地下鉄で約15〜20分（3号線 安国駅）。【理由】カフェ・ベーカリーカテゴリ1位。必須ではないが、この後の昼食（鍾路）へ向かう途中に立ち寄れる立地なので追加。ロンドンベーグルミュージアム系列の塩パン専門" },
